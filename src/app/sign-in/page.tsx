        ...
        <div className="w-full max-w-4xl flex flex-col lg:flex-row gap-8">
          ...
          <div className="flex-1">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="mt-2">
                <div className="space-y-2 flex flex-col items-end justify-left">
                  <a href="/reset-password" className="text-xs text-gray-500 hover:text-gray-700 transition-colors">
              ...
              <button
                type="submit"
                className="w-full bg-black text-white py-3 px-6 rounded-lg font-semibold hover:bg-gray-800 transition-colors mt-2"
              >
                Sign In
              </button>
            </form>
